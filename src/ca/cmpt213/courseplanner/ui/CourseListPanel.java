...
/**
 * Display the list of filtered courses, allow selection of a course and notify model of that selection. Subscribe as a listener for department-selection change notifications.
 */
