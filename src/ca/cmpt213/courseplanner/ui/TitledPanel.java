...
/**
 * Abstract base class for the titled panels in the UI. Supports drawing a header (title), and a main body with a border.
 */
...
public abstract class TitledPanel extends JPanel {
    ...
    final private void setEmptyBorder() {
        setBorder(BorderFactory.createEmptyBorder(EMPTY_BORDER_WIDTH, EMPTY_BORDER_WIDTH, EMPTY_BORDER_WIDTH, EMPTY_BORDER_WIDTH));
    }
